...
@overload
def cast_to(typ: type[T]) -> Callable[[Any], T]: ...
@overload
def cast_to(typ: T) -> Callable[[Any], T]: ...
@overload
def cast_to(typ: type[T], value: Any) -> T: ...
@overload
def cast_to(typ: T, value: Any) -> T: ...
def cast_to(typ: Any, value: Any = _MISSING) -> Any:
    """Extension of `typing.cast` allowing instance objects and
    callables can be used as the target type in addition to classes
    and other typing constructs. Can be used as a decorator.
    """
...
_UnboundMethod = TypeAliasType('_UnboundMethod', Callable[Concatenate[T, P], _ResReturn], type_params=(T, P, _ResReturn))

@overload
def cast_signature(source: _UnboundMethod[Any, _ResParams, _ResReturn], target: _UnboundMethod[_ResObject, P, Any], *, unbound_source: Literal[True], unbound_target: Literal[True]) -> _UnboundMethod[_ResObject, _ResParams, _ResReturn]: ...
@overload
def cast_signature(source: _UnboundMethod[Any, _ResParams, Any], target: _UnboundMethod[_ResObject, P, _ResReturn], *, unbound_source: Literal[True], unbound_target: Literal[True], args_only: Literal[True]) -> _UnboundMethod[_ResObject, _ResParams, _ResReturn]: ...
@overload
def cast_signature(source: _UnboundMethod[Any, P, _ResReturn], target: _UnboundMethod[_ResObject, _ResParams, Any], *, unbound_source: Literal[True], unbound_target: Literal[True], restype_only: Literal[True]) -> _UnboundMethod[_ResObject, _ResParams, _ResReturn]: ...
@overload
def cast_signature(source: _UnboundMethod[Any, _ResParams, _ResReturn], target: Callable[P, Any], *, unbound_source: Literal[True]) -> Callable[_ResParams, _ResReturn]: ...
@overload
def cast_signature(source: _UnboundMethod[Any, _ResParams, Any], target: Callable[P, _ResReturn], *, unbound_source: Literal[True], args_only: Literal[True]) -> Callable[_ResParams, _ResReturn]: ...
@overload
def cast_signature(source: _UnboundMethod[Any, P, _ResReturn], target: Callable[_ResParams, Any], *, unbound_source: Literal[True], restype_only: Literal[True]) -> Callable[_ResParams, _ResReturn]: ...
@overload
def cast_signature(source: Callable[_ResParams, _ResReturn], target: _UnboundMethod[_ResObject, P, Any], *, unbound_target: Literal[True]) -> _UnboundMethod[_ResObject, _ResParams, _ResReturn]: ...
@overload
def cast_signature(source: Callable[_ResParams, Any], target: _UnboundMethod[_ResObject, P, _ResReturn], *, unbound_target: Literal[True], args_only: Literal[True]) -> _UnboundMethod[_ResObject, _ResParams, _ResReturn]: ...
@overload
def cast_signature(source: Callable[P, _ResReturn], target: _UnboundMethod[_ResObject, _ResParams, Any], *, unbound_target: Literal[True], restype_only: Literal[True]) -> _UnboundMethod[_ResObject, _ResParams, _ResReturn]: ...
@overload
def cast_signature(source: Callable[_ResParams, _ResReturn], target: Callable[P, Any]) -> Callable[_ResParams, _ResReturn]: ...
@overload
def cast_signature(source: Callable[_ResParams, Any], target: Callable[P, _ResReturn], *, args_only: Literal[True]) -> Callable[_ResParams, _ResReturn]: ...
@overload
def cast_signature(source: Callable[P, _ResReturn], target: Callable[_ResParams, Any], *, restype_only: Literal[True]) -> Callable[_ResParams, _ResReturn]: ...
# decorators
@overload
def cast_signature(source: _UnboundMethod[Any, _ResParams, _ResReturn], *, unbound_source: Literal[True], unbound_target: Literal[True]) -> Callable[[_UnboundMethod[_ResObject, P, Any]], _UnboundMethod[_ResObject, _ResParams, _ResReturn]]: ...
@overload
def cast_signature(source: _UnboundMethod[Any, _ResParams, Any], *, unbound_source: Literal[True], unbound_target: Literal[True], args_only: Literal[True]) -> Callable[[_UnboundMethod[_ResObject, P, _ResReturn]], _UnboundMethod[_ResObject, _ResParams, _ResReturn]]: ...
@overload
def cast_signature(source: _UnboundMethod[Any, P, _ResReturn], *, unbound_source: Literal[True], unbound_target: Literal[True], restype_only: Literal[True]) -> Callable[[_UnboundMethod[_ResObject, _ResParams, Any]], _UnboundMethod[_ResObject, _ResParams, _ResReturn]]: ...
@overload
def cast_signature(source: _UnboundMethod[Any, _ResParams, _ResReturn], *, unbound_source: Literal[True]) -> Callable[[Callable[P, Any]], Callable[_ResParams, _ResReturn]]: ...
@overload
def cast_signature(source: _UnboundMethod[Any, _ResParams, Any], *, unbound_source: Literal[True], args_only: Literal[True]) -> Callable[[Callable[P, _ResReturn]], Callable[_ResParams, _ResReturn]]: ...
@overload
def cast_signature(source: _UnboundMethod[Any, P, _ResReturn], *, unbound_source: Literal[True], restype_only: Literal[True]) -> Callable[[Callable[_ResParams, Any]], Callable[_ResParams, _ResReturn]]: ...
@overload
def cast_signature(source: Callable[_ResParams, _ResReturn], *, unbound_target: Literal[True]) -> Callable[[_UnboundMethod[_ResObject, P, Any]], _UnboundMethod[_ResObject, _ResParams, _ResReturn]]: ...
@overload
def cast_signature(source: Callable[_ResParams, Any], *, unbound_target: Literal[True], args_only: Literal[True]) -> Callable[[_UnboundMethod[_ResObject, P, _ResReturn]], _UnboundMethod[_ResObject, _ResParams, _ResReturn]]: ...
@overload
def cast_signature(source: Callable[P, _ResReturn], *, unbound_target: Literal[True], restype_only: Literal[True]) -> Callable[[_UnboundMethod[_ResObject, _ResParams, Any]], _UnboundMethod[_ResObject, _ResParams, _ResReturn]]: ...
@overload
def cast_signature(source: Callable[_ResParams, _ResReturn]) -> Callable[[Callable[P, Any]], Callable[_ResParams, _ResReturn]]: ...
@overload
def cast_signature(source: Callable[_ResParams, Any], *, args_only: Literal[True]) -> Callable[[Callable[P, _ResReturn]], Callable[_ResParams, _ResReturn]]: ...
@overload
def cast_signature(source: Callable[P, _ResReturn], *, restype_only: Literal[True]) -> Callable[[Callable[_ResParams, Any]], Callable[_ResParams, _ResReturn]]: ...
def cast_signature(source: Any, target: Any = None, *, unbound_source: Any = False, unbound_target: Any = False, args_only: Any = False, restype_only: Any = False) -> Any:
    ...
    :type unbound_source: `Literal[True]` (optional, keyword-only)
    :param unbound_source: Informs the type checker that the signature
        of *source* is that of an unbound method (specifies that its
        first argument should be a bound object i.e. `self`).

    :type unbound_target: `Literal[True]` (optional, keyword-only)
    :param unbound_target: Informs the type checker that the signature
        of *target* is that of an unbound method (specifies that its
        first argument should be a bound object i.e. `self`).

    :type args_only: `Literal[True]` (optional, keyword-only)
    :param args_only: The source's return type signature will not
        override the return type signature of the target callable.
        Mutually exclusive with *restype_only*.

    :type restype_only: `Literal[True]` (optional, keyword-only)
    :param restype_only: The source's argument signature will not
        override the argument signature of the target callable.
        Mutually exclusive with *args_only*.
