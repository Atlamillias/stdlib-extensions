...
@overload
def cast_signature(source: _UnboundMethod[Any, _ResParams, _ResReturn], target: _UnboundMethod[_ResObject, P, Any], *, method_source: Literal[True], method_target: Literal[True]) -> _UnboundMethod[_ResObject, _ResParams, _ResReturn]: ...
@overload
def cast_signature(source: _UnboundMethod[Any, _ResParams, Any], target: _UnboundMethod[_ResObject, P, _ResReturn], *, method_source: Literal[True], method_target: Literal[True], args_only: Literal[True]) -> _UnboundMethod[_ResObject, _ResParams, _ResReturn]: ...
@overload
def cast_signature(source: _UnboundMethod[Any, P, _ResReturn], target: _UnboundMethod[_ResObject, _ResParams, Any], *, method_source: Literal[True], method_target: Literal[True], restype_only: Literal[True]) -> _UnboundMethod[_ResObject, _ResParams, _ResReturn]: ...
@overload
def cast_signature(source: _UnboundMethod[Any, _ResParams, _ResReturn], target: Callable[P, Any], *, method_source: Literal[True], method_target: Literal[False] = False) -> Callable[_ResParams, _ResReturn]: ...
@overload
def cast_signature(source: _UnboundMethod[Any, _ResParams, Any], target: Callable[P, _ResReturn], *, method_source: Literal[True], method_target: Literal[False] = False, args_only: Literal[True]) -> Callable[_ResParams, _ResReturn]: ...
@overload
def cast_signature(source: _UnboundMethod[Any, P, _ResReturn], target: Callable[_ResParams, Any], *, method_source: Literal[True], method_target: Literal[False] = False, restype_only: Literal[True]) -> Callable[_ResParams, _ResReturn]: ...
@overload
def cast_signature(source: Callable[_ResParams, _ResReturn], target: _UnboundMethod[_ResObject, P, Any], *, method_source: Literal[False] = False, method_target: Literal[True]) -> _UnboundMethod[_ResObject, _ResParams, _ResReturn]: ...
@overload
def cast_signature(source: Callable[_ResParams, Any], target: _UnboundMethod[_ResObject, P, _ResReturn], *, method_source: Literal[False] = False, method_target: Literal[True], args_only: Literal[True]) -> _UnboundMethod[_ResObject, _ResParams, _ResReturn]: ...
@overload
def cast_signature(source: Callable[P, _ResReturn], target: _UnboundMethod[_ResObject, _ResParams, Any], *, method_source: Literal[False] = False, method_target: Literal[True], restype_only: Literal[True]) -> _UnboundMethod[_ResObject, _ResParams, _ResReturn]: ...
@overload
...
# decorators
@overload
def cast_signature(source: _UnboundMethod[Any, _ResParams, _ResReturn], *, method_source: Literal[True], method_target: Literal[True]) -> Callable[[_UnboundMethod[_ResObject, P, Any]], _UnboundMethod[_ResObject, _ResParams, _ResReturn]]: ...
@overload
def cast_signature(source: _UnboundMethod[Any, _ResParams, Any], *, method_source: Literal[True], method_target: Literal[True], args_only: Literal[True]) -> Callable[[_UnboundMethod[_ResObject, P, _ResReturn]], _UnboundMethod[_ResObject, _ResParams, _ResReturn]]: ...
@overload
def cast_signature(source: _UnboundMethod[Any, P, _ResReturn], *, method_source: Literal[True], method_target: Literal[True], restype_only: Literal[True]) -> Callable[[_UnboundMethod[_ResObject, _ResParams, Any]], _UnboundMethod[_ResObject, _ResParams, _ResReturn]]: ...
@overload
def cast_signature(source: _UnboundMethod[Any, _ResParams, _ResReturn], *, method_source: Literal[True], method_target: Literal[False] = False) -> Callable[[Callable[P, Any]], Callable[_ResParams, _ResReturn]]: ...
@overload
def cast_signature(source: _UnboundMethod[Any, _ResParams, Any], *, method_source: Literal[True], method_target: Literal[False] = False, args_only: Literal[True]) -> Callable[[Callable[P, _ResReturn]], Callable[_ResParams, _ResReturn]]: ...
@overload
def cast_signature(source: _UnboundMethod[Any, P, _ResReturn], *, method_source: Literal[True], method_target: Literal[False] = False, restype_only: Literal[True]) -> Callable[[Callable[_ResParams, Any]], Callable[_ResParams, _ResReturn]]: ...
@overload
def cast_signature(source: Callable[_ResParams, _ResReturn], *, method_source: Literal[False] = False, method_target: Literal[True]) -> Callable[[_UnboundMethod[_ResObject, P, Any]], _UnboundMethod[_ResObject, _ResParams, _ResReturn]]: ...
@overload
def cast_signature(source: Callable[_ResParams, Any], *, method_source: Literal[False] = False, method_target: Literal[True], args_only: Literal[True]) -> Callable[[_UnboundMethod[_ResObject, P, _ResReturn]], _UnboundMethod[_ResObject, _ResParams, _ResReturn]]: ...
@overload
def cast_signature(source: Callable[P, _ResReturn], *, method_source: Literal[False] = False, method_target: Literal[True], restype_only: Literal[True]) -> Callable[[_UnboundMethod[_ResObject, _ResParams, Any]], _UnboundMethod[_ResObject, _ResParams, _ResReturn]]: ...
@overload
